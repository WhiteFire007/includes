		...
		if (IsTank(client))
		{
			...
			if (index >= 0 && index <= 16)
			{
				if (index != 0 || (index == 0 && bDefaultOverride))
				{
					...
					switch(index)
					{
						case 0: { TankName = "Default"; }
						case 1: { TankName = "Spawn"; }
						case 2: { TankName = "Smasher"; }
						case 3: { TankName = "Warp"; }
						case 4: { TankName = "Meteor"; }
						case 5: { TankName = "Spitter"; }
						case 6: { TankName = "Heal"; }
						case 7: { TankName = "Fire"; }
						case 8: { TankName = "Ice"; }
						case 9: { TankName = "Jockey "; }
						case 10: { TankName = "Ghost"; }
						case 11: { TankName = "Shock"; }
						case 12: { TankName = "Witch "; }
						case 13: { TankName = "Shield "; }
						case 14: { TankName = "Cobalt "; }
						case 15: { TankName = "Jumper "; }
						case 16: { TankName = "Gravity "; }
					}
					
					CPrintToChatAll("\x05Tank\x01 Apperead of \x04Type\x01:\x03%s", TankName);
				}
			}
		}
	}
...
{
	int target, float InfectedPos[3], SurvivorPos[3], nearest = 0.0;
   	for (int i=1; i<=MaxClients; i++)
	{
